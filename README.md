...
| CMakeLists.txt | Builds only the package-owned sonar messages and installs sensor runtime scripts and contract helpers. | catkin, ROS Noetic message generation | catkin build |

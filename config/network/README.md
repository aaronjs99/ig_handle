...
| sensor_network.yaml | Canonical runtime endpoints, ROS graph addresses, mocap endpoints, and local interface roles. | Reviewed deployment addresses | scripts/sensors/network.py, GRANDE runner, and bringup |

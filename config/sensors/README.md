...
| --- | --- | --- | --- |
| sensor_contract.yaml | Defines the canonical deployed sensor inventory, roles, topics, launch policy, reachability, provider state, readiness thresholds, and the false-by-default DT100 hardware/source-endpoint gate. | sensor_network.yaml, cameras/, sonar/ | scripts/sensor_contract.py, scripts/sensor_bringup.py, launch/sensors.launch |

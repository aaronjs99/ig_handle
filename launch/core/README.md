...
| start_rosserial.launch | Starts the conditional Teensy rosserial launcher and supplies the canonical PPS, camera-time, IMU-time, and non-authoritative timing-status diagnostic topics. | /dev/teensy, scripts/teensy/teensy_rosserial_launcher.py | GRANDE bringup and embedded timing acquisition |

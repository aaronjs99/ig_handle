...
| start_sonar.launch | Selects the DeltaT, passive Imagenex UDP, or guarded Ping360 provider and enforces configured reachability and active-transmit authorization. | scripts/sonar/sonar.py, scripts/sensor_contract_launch_eval.py, config/sensors/sonar/profiles.yaml, optional dt100_driver | scripts/sensor_bringup.py through the sensor contract |

...
| --- | --- | --- | --- |
| Linux_DeltaT_v1023_x86_64 | Provides the pinned vendor DeltaT executable launched only by the configured DeltaT provider. | Compatible x86-64 host and physical DeltaT interface | CMake installation, include/deltat_runner.py |
